(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('d3kit'), require('@angular/common')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'd3kit', '@angular/common'], factory) :
	(factory((global.morphatic = global.morphatic || {}, global.morphatic.charts = {}),global.ng.core,global.d3Kit,global.ng.common));
}(this, (function (exports,core,d3kit,common) { 'use strict';
...
function continuous(deinterpolate, reinterpolate) {
    var domain = unit, range = unit, interpolate$$1 = interpolateValue, clamp = false, piecewise, output, input;
    function rescale() {
...
exports.BarChartComponent = (function (_super) {
    __extends(BarChartComponent, _super);
    function BarChartComponent(el) {
        var _this = _super.call(this, el.nativeElement) || this;
        _this.el = el;
        // define private properties
        _this.xScale = band().range([0, _this.getInnerWidth()]).padding(0.1);
        _this.yScale = linear().range([_this.getInnerHeight(), 0]);
        _this.colors = ordinal(schemeCategory10);
        _this.xAxisG = _this.rootG.append('g');
        _this.yAxisG = _this.rootG.append('g');
        // add basic event listeners
        _this.draw = _this.draw.bind(_this);
        _this.on('resize.default', _this.draw);
        _this.on('data.default', _this.draw);
        // setup autoresize
        _this.fit({
            mode: 'aspectRatio',
            ratio: 4 / 3,
            maxWidth: defaultView(el.nativeElement).innerWidth * 0.95,
            maxHeight: defaultView(el.nativeElement).innerWidth * 0.95 * 0.75,
        }, true);
        return _this;
    }
    ...
    BarChartComponent.prototype.draw = function () {
        ...
        this.xScale.domain(data.map(function (d) { return d.category; }))
            .range([0, this.getInnerWidth()]);
        this.yScale.domain([0, max(data, function (d) { return +d.value; })])
            .range([this.getInnerHeight(), 0]);
        // create a set of bars
        var bars = this.rootG.selectAll('.bar').data(data);
        // (re)draw the bars (rectangles)
        var barEntry = bars.enter().append('rect')
            .attr('class', 'bar');
        bars.merge(barEntry)
            .attr('x', function (d) { return _this.xScale(d.category); })
            .attr('width', this.xScale.bandwidth())
            .attr('y', function (d) { return _this.yScale(+d.value); })
            .attr('height', function (d) { return _this.getInnerHeight() - _this.yScale(+d.value); })
            .style('fill', function (d) { return _this.colors(d.category); });
...
], exports.BarChartComponent.prototype, "bcdata", void 0);
...
exports.MorphaticChartsModule = (function () {
    function MorphaticChartsModule() {
    }
    return MorphaticChartsModule;
}());
exports.MorphaticChartsModule = __decorate([
    core.NgModule({
        imports: [
            common.CommonModule
        ],
...
], exports.MorphaticChartsModule);

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=morphatic-charts.umd.js.map

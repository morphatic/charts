...
let BarChartComponent = class BarChartComponent extends SvgChart {
    constructor(el) {
        super(el.nativeElement);
        this.el = el;
        // define private properties
        this.xScale = band().range([0, this.getInnerWidth()]).padding(0.1);
        this.yScale = linear().range([this.getInnerHeight(), 0]);
    ...
    draw() {
        ...
        this.yScale.domain([0, max(data, (d) => +d.value)])
        ...
        bars.merge(barEntry)
            ...
            .attr('height', (d) => this.getInnerHeight() - this.yScale(+d.value))
...
let MorphaticChartsModule = class MorphaticChartsModule {
};
